...
import steps.AddAIssue;

public class TestAddIssue extends JUnitStories {

	public TestAddIssue() {
		super();
		this.configuredEmbedder().candidateSteps().add(new AddAIssue());
	}
	...
	protected List<String> storyPaths() {
		return Arrays.asList("stories/AddAIssue.story");
	}
